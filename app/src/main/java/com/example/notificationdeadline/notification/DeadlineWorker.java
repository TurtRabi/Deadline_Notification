...
public class DeadlineWorker extends Worker {
    ...
    public DeadlineWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
        ...
        notificationHistoryService = new NotificationHistoryService( context);
    }
    ...
    public Result doWork() {
        ...
        // Hiển thị cảnh báo KHẨN CẤP (dưới 6 tiếng)
        ...
        // Hiển thị cảnh báo NHẸ NHÀNG (6–10 tiếng)
        ...
        // Hiển thị cảnh báo NHẸ NHÀNG (10-24 tiếng)
